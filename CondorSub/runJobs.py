...
def generateSubFile(outputName,shell_name):
    ...
    with open(SubfileName, 'w') as sout:
        ...
        sout.write("output                  = "+base_folder+"/Analyzer/CondorSub/Logs/out.$(ClusterId)_Run"+str(outputName)+".dat"+"\n")
        sout.write("error                   = "+base_folder+"/Analyzer/CondorSub/Logs/error.$(ClusterId)_Run"+str(outputName)+".err"+"\n")
        sout.write("log                     = "+base_folder+"/Analyzer/CondorSub/Logs/log.$(ClusterId)_Run"+str(outputName)+".log"+"\n")
